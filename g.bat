...
REM python gitinspector.py --since=2016/09/01 ssh://git@stash.billing.ru:2222/scm/uniblp/uniblp.git >> out1.txt
REM python gitinspector.py --since=2017/03/03 --until=2017/03/03 https://Alexander.Zolotarev@stash.billing.ru/scm/spp/spp-ui.git >> out.txt
...
REM ---
REM CHDB DEV
REM python gitinspector.py --since=2017/01/01 https://Alexander.Zolotarev@stash.billing.ru/scm/chargesdb/chargesdb_tests.git https://Alexander.Zolotarev@stash.billing.ru/scm/chargesdb/charging_data_conveyer.git https://Alexander.Zolotarev@stash.billing.ru/scm/chargesdb/customer_guardian.git https://Alexander.Zolotarev@stash.billing.ru/scm/chargesdb/customer_reporter.git https://Alexander.Zolotarev@stash.billing.ru/scm/chargesdb/oapi_chargesdb_api_backend.git >> out.txt

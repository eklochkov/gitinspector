...
class DaoCommitDiff(object):
    def insert_change(self, CommitDiff):
        raise NotImplementedError(_("Method insert_change not yet supported in") + " \"" + self.__class__.__name__ + "\".")

    def insert_commit(self, email, date):
        raise NotImplementedError(_("Method insert_commit not yet supported in") + " \"" + self.__class__.__name__ + "\".")
    ...
    def get_code_type_data(self):  # must return array of array with sum modifies with code type as column
        raise NotImplementedError(_("Method get_code_type_data not yet supported in") + " \"" + self.__class__.__name__ + "\".")
    ...
    def insert_org_structure(self, org_structure):
        raise NotImplementedError(_("Method insert_org_structure not yet supported in") + " \"" + self.__class__.__name__ + "\".")
